"""One-off script: converts ../racetrack_waypoints.txt into a fixed-width-track.csv format
(x, y, left/right half-width) expected by external raceline-optimization tools."""
import numpy as np
