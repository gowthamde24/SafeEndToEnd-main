"""One-off script: for each optimized racing-line point in ../traj_race_cl.csv, finds the
nearest ../racetrack_waypoints.txt waypoint and carries over its speed, saving ../waypoints_new.csv."""
import numpy as np
